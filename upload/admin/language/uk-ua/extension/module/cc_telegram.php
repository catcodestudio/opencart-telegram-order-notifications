...
$_['entry_retry']               = 'Повторна відправка';
$_['entry_max_attempts']        = 'Максимум спроб';
...
$_['help_retry']                = 'Якщо Telegram не відповів, повідомлення про замовлення надсилається ще раз за розкладом. Текст формується заново з актуального замовлення.';
$_['help_max_attempts']         = 'Скільки разів пробувати доставити одне повідомлення (враховуючи першу спробу).';
$_['help_cron']                 = 'В OpenCart 3 немає власного планувальника, тому додайте цю адресу в cron свого хостингу — раз на годину:';
